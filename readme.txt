...
For 32 or 64-bit operating systems:
         ModelMuseSetup32_3_4.exe
         ModelMuse32_3_4.zip
For 64-bit operating systems:
         ModelMuseSetup64_3_4.exe
         ModelMuse64_3_4.zip
...
The file ModelMuseSource3_4.zip contains the source code for ModelMuse, 
...
ModelMuse will be installed in C:\Program Files\USGS\ModelMuse3_4 or
C:\Program Files (x86)\USGS\ModelMuse3_4. If 
...
Included in directory ModelMuse3_4\doc is the report on ModelMuse as a 
