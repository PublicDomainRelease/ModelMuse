...
procedure TframeCustomSutraFeature.btnDeleteClick(Sender: TObject);
begin
...
procedure TframeCustomSutraFeature.GetData(
...
procedure TframeCustomSutraFeature.RefreshNodeState;
begin
...
procedure TframeCustomSutraFeature.seNumberOfTimesChange(Sender: TObject);
var
  ColIndex: Integer;
begin
  FDeleting := True;
...
procedure TframeCustomSutraFeature.UpdateCheckState;
begin
...
procedure TframeCustomSutraFeature.SetScheduleIndex(const ScheduleName
