...
uses
  CustomModflowWriterUnit, ScreenObjectUnit, PhastModelUnit, GoPhastTypes,
  RealListUnit, SysUtils, Forms, ModflowPackageSelectionUnit,
  Classes, ModflowBoundaryDisplayUnit;
...
uses
  ...
  frmErrorsAndWarningsUnit, ModflowUnitNumbers, Contnrs;
...
begin
  ...
  WriteToNameFile(StrFHB, FUnitNumber, FNameOfFile, foInput);
