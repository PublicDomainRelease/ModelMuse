                ...
                try
                  ...
                  begin
                    ...
                    begin
                      case DataArray.DataType of
                        rdtDouble:
                          AGrid.Cells[ColIndex + 1, RowIndex + 1] := FloatToStr(DataArray.RealData[LayerIndex, RowIndex, ColIndex]);
                        rdtInteger:
                          AGrid.Cells[ColIndex + 1, RowIndex + 1] := IntToStr(DataArray.IntegerData[LayerIndex, RowIndex, ColIndex]);
                        rdtBoolean:
                          AGrid.Checked[ColIndex + 1, RowIndex + 1] := DataArray.BooleanData[LayerIndex, RowIndex, ColIndex];
                        rdtString:
                          AGrid.Cells[ColIndex + 1, RowIndex + 1] := DataArray.StringData[LayerIndex, RowIndex, ColIndex];
                      end;
                    end;
                  end;
                finally
                  ...
                  begin
                    ...
                    begin
                      case DataArray.DataType of
                        ...
                        rdtInteger:
                          AGrid.Cells[ColIndex + 1, LayerIndex + 1] := IntToStr(DataArray.IntegerData[LayerIndex, RowIndex, ColIndex]);
                        rdtBoolean:
                          AGrid.Checked[ColIndex + 1, LayerIndex + 1] := DataArray.BooleanData[LayerIndex, RowIndex, ColIndex];
                        rdtString:
                          AGrid.Cells[ColIndex + 1, LayerIndex + 1] := DataArray.StringData[LayerIndex, RowIndex, ColIndex];
                      end;
                    end;
                  end;
                finally
                ...
                try
                  ...
                  begin
                    ...
                    begin
                      case DataArray.DataType of
                        rdtDouble:
                          AGrid.Cells[RowIndex + 1, LayerIndex + 1] := FloatToStr(DataArray.RealData[LayerIndex, RowIndex, ColIndex]);
                        rdtInteger:
                          AGrid.Cells[RowIndex + 1, LayerIndex + 1] := IntToStr(DataArray.IntegerData[LayerIndex, RowIndex, ColIndex]);
                        rdtBoolean:
                          AGrid.Checked[RowIndex + 1, LayerIndex + 1] := DataArray.BooleanData[LayerIndex, RowIndex, ColIndex];
                        rdtString:
                          AGrid.Cells[RowIndex + 1, LayerIndex + 1] := DataArray.StringData[LayerIndex, RowIndex, ColIndex];
                      end;
                    end;
                  end;
                finally
        ...
        try
          ...
          begin
            ...
            begin
              case DataArray.DataType of
                rdtDouble:
                  AGrid.Cells[ColIndex + 1, LayerIndex + 1] := FloatToStr(DataArray.RealData[LayerIndex, 0, ColIndex]);
                rdtInteger:
                  AGrid.Cells[ColIndex + 1, LayerIndex + 1] := IntToStr(DataArray.IntegerData[LayerIndex, 0, ColIndex]);
                rdtBoolean:
                  AGrid.Checked[ColIndex + 1, LayerIndex + 1] := DataArray.BooleanData[LayerIndex, 0, ColIndex];
                rdtString:
                  AGrid.Cells[ColIndex + 1, LayerIndex + 1] := DataArray.StringData[LayerIndex, 0, ColIndex];
              end;
            end;
          end;
        finally
        ...
        try
          ...
          begin
            ...
            begin
              case DataArray.DataType of
                rdtDouble:
                  AGrid.Cells[RowIndex + 1, LayerIndex + 1] := FloatToStr(DataArray.RealData[LayerIndex, RowIndex, 0]);
                rdtInteger:
                  AGrid.Cells[RowIndex + 1, LayerIndex + 1] := IntToStr(DataArray.IntegerData[LayerIndex, RowIndex, 0]);
                rdtBoolean:
                  AGrid.Checked[RowIndex + 1, LayerIndex + 1] := DataArray.BooleanData[LayerIndex, RowIndex, 0];
                rdtString:
                  AGrid.Cells[RowIndex + 1, LayerIndex + 1] := DataArray.StringData[LayerIndex, RowIndex, 0];
              end;
            end;
          end;
        finally
