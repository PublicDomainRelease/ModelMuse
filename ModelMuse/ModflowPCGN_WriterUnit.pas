...
begin
  ...
  begin
    ...
    WriteToNameFile(StrData, UNIT_PC, NameOfFile, foOutput);
  end
  else
  begin
    UNIT_PC := 0;
  ...
  begin
    ...
    WriteToNameFile(StrData, UNIT_TS, NameOfFile, foOutput);
  end
  else
  begin
    UNIT_TS := 0;
...
begin
  ...
  begin
    ...
    begin
      ...
      WriteToNameFile(StrData, IPUNIT, NameOfFile, foOutput);
    end;
    WriteInteger(IPUNIT);
