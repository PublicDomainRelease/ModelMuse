...
begin
  TopPoint := frmGoPhast.Grid.TwoDElementCenter(
    frmGoPhast.Grid.ColumnCount div 2,
    frmGoPhast.Grid.RowCount div 2);
  XCoordinate := TopPoint.X;
  YCoordinate := TopPoint.Y;
  SetTopPosition(XCoordinate, YCoordinate);

  FrontPoint := frmGoPhast.Grid.ThreeDElementCenter(
    frmGoPhast.Grid.ColumnCount div 2, 0,
    frmGoPhast.Grid.LayerCount div 2);
  XCoordinate := FrontPoint.X;
  ZCoordinate := FrontPoint.Z;
  SetFrontPosition(XCoordinate, ZCoordinate);

  SidePoint := frmGoPhast.Grid.ThreeDElementCenter(0,
    frmGoPhast.Grid.RowCount div 2,
    frmGoPhast.Grid.LayerCount div 2);
