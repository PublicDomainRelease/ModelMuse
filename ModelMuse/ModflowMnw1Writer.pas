...
begin
  ...
  begin
    ...
    WriteInteger(iunw1);
    NewLine;
    WriteToNameFile(StrData, iunw1, WellFileName, foOutput);
  end;
end;
...
begin
  ...
  begin
    ...
    NewLine;
    WriteToNameFile(StrData, iunby, ByNodeFileName, foOutput);
  end;
end;
...
begin
  ...
  begin
    ...
    NewLine;
    WriteToNameFile(StrData, iunqs, QSumFileName, foOutput);
  end;
end;
