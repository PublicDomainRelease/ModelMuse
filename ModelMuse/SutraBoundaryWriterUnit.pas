    ...
    begin
      ...
      begin
        ...
        begin
          ...
          begin
            if UDataArray.IsValue[LayerIndex, RowIndex, ColIndex] <> PriorUDataArray.IsValue[LayerIndex, RowIndex, ColIndex] then
            begin
              Inc(Count);
            end
...
procedure TSutraBoundaryWriter.WriteFile(FileName: string; BoundaryNodes: TIntegerList);
var
  UTimeList: TSutraMergedTimeList;
