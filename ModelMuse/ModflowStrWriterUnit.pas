...
uses
  Classes, Generics.Collections,CustomModflowWriterUnit,
    ...
    csfBinary:
      begin
        ...
        WriteToNameFile(StrDATABINARY,
          ISTCB2, ChangeFileExt(FNameOfFile,'.str_flow'), foOutput);
      end;
  else
    begin
      Assert(False);
...
begin
  ...
  WriteToNameFile(StrSTR, Model.UnitNumbers.UnitNumber(StrSTR), FNameOfFile, foInput);
//  Evaluate;
  Application.ProcessMessages;
  if not frmProgressMM.ShouldContinue then
  begin
