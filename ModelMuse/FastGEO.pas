...
(**************[   Box type     ]***************)
type TBoxPtr   = ^TRectangle;
     TBox      = array [1..2] of TPoint3D;
...
function RobustCollinear(const x1,y1,z1,x2,y2,z2,x3,y3,z3:TFloat; const Epsilon : TFloat = Epsilon_High):Boolean;              overload;
function RobustCollinear(const PointA,PointB,PointC:TPoint3D;  const Epsilon : TFloat = Epsilon_High):Boolean;                 overload;
...
function Intersect(const x1,y1,z1,x2,y2,z2,x3,y3,z3,x4,y4,z4:TFloat; const fuzzy:TFloat = Zero):Boolean;                       overload;
function Intersect(const P1,P2,P3,P4:TPoint3D; const fuzzy:TFloat = Zero):Boolean;                                             overload;
function Intersect(const Segment1,Segment2:TSegment3D; const fuzzy:TFloat = Zero):Boolean;                                     overload;
...
procedure IntersectionPoint(const x1,y1,z1,x2,y2,z2,x3,y3,z3,x4,y4,z4,Fuzzy:TFloat; out Nx,Ny,Nz:TFloat);                      overload;
procedure IntersectionPoint(const P1,P2,P3,P4:TPoint3D; const Fuzzy:TFloat; out Nx,Ny,Nz:TFloat);                              overload;
function  IntersectionPoint(const P1,P2,P3,P4:TPoint3D; const Fuzzy:TFloat = Epsilon):TPoint3D;                                overload;
function  IntersectionPoint(const Segment1,Segment2:TSegment3D; const Fuzzy:TFloat = Epsilon):TPoint3D;                        overload;
...
function PointInBox(const Px,Py,Pz:TFloat; const x1,y1,z1,x2,y2,z2:TFloat):Boolean;                                            overload;
function PointInBox(const Point:TPoint3D;  const x1,y1,z1,x2,y2,z2:TFloat):Boolean;                                            overload;
function PointInBox(const Px,Py,Pz:TFloat; const Box:TBox):Boolean;                                                            overload;
function PointInBox(const Point:TPoint3D;  const Box:TBox):Boolean;                                                            overload;
...
procedure Centroid(const x1,y1,x2,y2,x3,y3,x4,y4:TFloat; out x,y:TFloat);                                                      overload;
...
procedure Centroid(const Quadix:TQuadix2D; out x,y:TFloat);                                                                    overload;
function  Centroid(const P1,P2,P3:TPoint2D):TPoint2D;                                                                          overload;
function  Centroid(const P1,P2,P3,P4:TPoint2D):TPoint2D;                                                                       overload;
function  Centroid(const Triangle:TTriangle2D):TPoint2D;                                                                       overload;
function  Centroid(const Quadix:TQuadix2D):TPoint2D;                                                                           overload;
...
function Clip(const x1,y1,x2,y2,x3,y3,x4,y4:TFloat; out Cx1,Cy1,Cx2,Cy2:TFloat):Boolean;                                       overload;
...
function Clip(const Rect1,Rect2 : TRectangle;                              out CRect : TRectangle):Boolean;                    overload;
...
function ProjectPoint0  (const Point:TPoint2D; const Distance:TFloat):TPoint2D;                                                overload;
function ProjectPoint45 (const Point:TPoint2D; const Distance:TFloat):TPoint2D;                                                overload;
function ProjectPoint90 (const Point:TPoint2D; const Distance:TFloat):TPoint2D;                                                overload;
function ProjectPoint135(const Point:TPoint2D; const Distance:TFloat):TPoint2D;                                                overload;
function ProjectPoint180(const Point:TPoint2D; const Distance:TFloat):TPoint2D;                                                overload;
function ProjectPoint225(const Point:TPoint2D; const Distance:TFloat):TPoint2D;                                                overload;
function ProjectPoint270(const Point:TPoint2D; const Distance:TFloat):TPoint2D;                                                overload;
function ProjectPoint315(const Point:TPoint2D; const Distance:TFloat):TPoint2D;                                                overload;

function ProjectObject(const Point    : TPoint2D;         const Angle,Distance:TFloat):TPoint2D;                               overload;
function ProjectObject(const Segment  : TSegment2D;       const Angle,Distance:TFloat):TSegment2D;                             overload;
function ProjectObject(const Triangle : TTriangle2D;      const Angle,Distance:TFloat):TTriangle2D;                            overload;
function ProjectObject(const Quadix   : TQuadix2D;        const Angle,Distance:TFloat):TQuadix2D;                              overload;
function ProjectObject(const Circle   : TCircle;          const Angle,Distance:TFloat):TCircle;                                overload;
function ProjectObject(const Polygon  : TPolygon2D;       const Angle,Distance:TFloat):TPolygon2D;                             overload;
function ProjectObject(const GeoObj   : TGeometricObject; const Angle,Distance:TFloat):TGeometricObject;                       overload;
...
procedure ShortenSegment(const Amount:TFloat; var x1,y1,x2,y2:TFloat);                                                         overload;
procedure ShortenSegment(const Amount:TFloat; var x1,y1,z1,x2,y2,z2:TFloat);                                                   overload;
...
procedure GenerateRandomPoints(const Triangle:TTriangle3D;   var PointList:array of TPoint3D);                                 overload;
...
procedure GenerateRandomPoints(const Quadix:TQuadix3D;       var PointList:array of TPoint3D);                                 overload;
...
function RobustCollinear(const x1,y1,z1,x2,y2,z2,x3,y3,z3:TFloat; const Epsilon : TFloat = Epsilon_High):Boolean;
var
  LeyDist1 : TFloat;
  LeyDist2 : TFloat;
  LeyDist3 : TFloat;
...
function RobustCollinear(const PointA,PointB,PointC:TPoint3D;  const Epsilon : TFloat = Epsilon_High):Boolean;
begin
...
function Intersect(const x1,y1,z1,x2,y2,z2,x3,y3,z3,x4,y4,z4:TFloat; const fuzzy : TFloat = Zero):Boolean;
begin
...
function Intersect(const P1,P2,P3,P4:TPoint3D; const fuzzy:TFloat = Zero):Boolean;
begin
...
function Intersect(const Segment1,Segment2:TSegment3D; const fuzzy:TFloat = Zero):Boolean;
begin
...
procedure IntersectionPoint(const x1,y1,z1,x2,y2,z2,x3,y3,z3,x4,y4,z4,Fuzzy:TFloat; out Nx,Ny,Nz:TFloat);
var
  ux : TFloat;
  uy : TFloat;
  uz : TFloat;
...
procedure IntersectionPoint(const P1,P2,P3,P4:TPoint3D; const Fuzzy:TFloat; out Nx,Ny,Nz:TFloat);
begin
  IntersectionPoint(P1.x,P1.y,P1.z,P2.x,P2.y,P2.z,P3.x,P3.y,P3.z,P4.x,P4.y,P4.z,Fuzzy,Nx,Ny,Nz);
end;
(* End of IntersectionPoint *)

function IntersectionPoint(const P1,P2,P3,P4:TPoint3D; const Fuzzy:TFloat = Epsilon):TPoint3D;
begin
  IntersectionPoint(P1.x,P1.y,P1.z,P2.x,P2.y,P2.z,P3.x,P3.y,P3.z,P4.x,P4.y,P4.z,Fuzzy,Result.x,Result.y,Result.z);
end;
(* End of IntersectionPoint *)

function IntersectionPoint(const Segment1,Segment2:TSegment3D; const Fuzzy:TFloat = Epsilon):TPoint3D;
begin
  Result := IntersectionPoint(Segment1[1],Segment1[2],Segment2[1],Segment2[2]);
end;
(* End of IntersectionPoint *)
...
function PointInBox(const Px,Py,Pz:TFloat; const x1,y1,z1,x2,y2,z2:TFloat):Boolean;
begin
  Result := (((x1 <= Px) and (Px <= x2) and (y1 <= Py) and (Py <= y2)) or
...
function PointInBox(const Point:TPoint3D;  const x1,y1,z1,x2,y2,z2:TFloat):Boolean;
begin
...
function PointInBox(const Px,Py,Pz:TFloat; const Box:TBox):Boolean;
begin
...
function PointInBox(const Point:TPoint3D;  const Box:TBox):Boolean;
begin
...
procedure Centroid(const x1,y1,x2,y2,x3,y3,x4,y4:TFloat; out x,y:TFloat);
var
  asum : TFloat;
  term : TFloat;
begin
...
procedure Centroid(const Quadix:TQuadix2D; out x,y:TFloat);
begin
...
function Centroid(const P1,P2,P3,P4:TPoint2D):TPoint2D;
begin
...
function  Centroid(const Quadix:TQuadix2D):TPoint2D;
begin
...
function Clip(const x1,y1,x2,y2,x3,y3,x4,y4:TFloat; out Cx1,Cy1,Cx2,Cy2 : TFloat) : Boolean;
...
function Clip(const Rect1,Rect2 : TRectangle; out CRect:TRectangle):Boolean;
...
function ProjectPoint0(const Point:TPoint2D; const Distance:TFloat):TPoint2D;
begin
...
function ProjectPoint45(const Point:TPoint2D; const Distance:TFloat):TPoint2D;
begin
...
function ProjectPoint90(const Point:TPoint2D; const Distance:TFloat):TPoint2D;
begin
...
function ProjectPoint135(const Point:TPoint2D; const Distance:TFloat):TPoint2D;
begin
...
function ProjectPoint180(const Point:TPoint2D; const Distance:TFloat):TPoint2D;
begin
...
function ProjectPoint225(const Point:TPoint2D; const Distance:TFloat):TPoint2D;
begin
...
function ProjectPoint270(const Point:TPoint2D; const Distance:TFloat):TPoint2D;
begin
...
function ProjectPoint315(const Point:TPoint2D; const Distance:TFloat):TPoint2D;
begin
...
function ProjectObject(const Point:TPoint2D; const Angle,Distance:TFloat):TPoint2D;
begin
...
function ProjectObject(const Segment:TSegment2D; const Angle,Distance:TFloat):TSegment2D;
begin
...
function ProjectObject(const Triangle:TTriangle2D; const Angle,Distance:TFloat):TTriangle2D;
begin
...
function ProjectObject(const Quadix:TQuadix2D; const Angle,Distance:TFloat):TQuadix2D;
begin
...
function ProjectObject(const Circle:TCircle; const Angle,Distance:TFloat):TCircle;
begin
...
function ProjectObject(const Polygon : TPolygon2D; const Angle,Distance:TFloat):TPolygon2D;
var
  i : Integer;
begin
  Setlength(Result,Length(Polygon));
...
function ProjectObject(const GeoObj : TGeometricObject; const Angle,Distance:TFloat):TGeometricObject;
begin
...
procedure ShortenSegment(const Amount:TFloat; var x1,y1,x2,y2:TFloat);
var
...
procedure ShortenSegment(const Amount:TFloat; var x1,y1,z1,x2,y2,z2:TFloat);
var
  SegmentLength : TFloat;
  DistRatio     : TFloat;
  Dx            : TFloat;
...
procedure GenerateRandomPoints(const Triangle:TTriangle3D; var PointList:array of TPoint3D);
var
  a : TFloat;
  b : TFloat;
  c : TFloat;
...
procedure GenerateRandomPoints(const Quadix:TQuadix3D; var PointList : array of TPoint3D);
(*  Note: It is assumed the input Quadix is convex. *)
var
  i  : Integer;
  a  : TFloat;
