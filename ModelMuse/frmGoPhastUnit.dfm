inherited frmGoPhast: TfrmGoPhast
  ...
  object mmMainMenu: TMainMenu
    ...
    object Model1: TMenuItem
      Caption = 'Model'
      HelpContext = 2390
      object Modflow1: TMenuItem
        Action = acModflowActive
        GroupIndex = 1
        RadioItem = True
      end
      object Phast1: TMenuItem
  ...
  object alActionList: TActionList
    ...
    object acShowGridLines2D: TAction
      Category = 'View'
      AutoCheck = True
      Caption = 'Show 2D Grid'
      Checked = True
      Hint = 'Show 2D gridlines|Show gridlines in 2D views.'
      ImageIndex = 71
