inherited frmGoPhast: TfrmGoPhast
  ...
  object cbControlBar: TControlBar
    ...
    object tbarEditScreenObjects: TToolBar
      ...
      object tbContourData: TToolButton
        Left = 200
        Top = 0
  ...
  object mmMainMenu: TMainMenu
    ...
    object miFile: TMenuItem
      ...
      object miImport: TMenuItem
        ...
        object miHeadObservationResults: TMenuItem
          Caption = 'Head Observation Results...'
          OnClick = miHeadObservationResultsClick
        end
        object miModpathPathline: TMenuItem
          Caption = 'MODPATH Pathlines...'
          HelpContext = 3541
          OnClick = miModpathPathlineClick
        end
        object miModpathEndpoints: TMenuItem
          Caption = 'MODPATH Endpoints...'
          HelpContext = 3543
          OnClick = miModpathEndpointsClick
        end
        object miModpathTimeSeries: TMenuItem
          Caption = 'MODPATH Time Series...'
          HelpContext = 3544
          OnClick = miModpathTimeSeriesClick
        end
    ...
    object miData: TMenuItem
      ...
      object miColorGrid: TMenuItem
        Action = acColorGrid
      end
      object ContourData1: TMenuItem
        Action = acContourData
      end
      object miConfigureHeadObservationResults: TMenuItem
        Caption = 'Configure Head Observation Results...'
        Enabled = False
        OnClick = miConfigureHeadObservationResultsClick
      end
      object miConfigurePathlines: TMenuItem
        Caption = 'Configure Pathlines...'
        Enabled = False
        HelpContext = 3541
        OnClick = miModpathPathlineClick
      end
      object miConfigureEndpoints: TMenuItem
        Caption = 'Configure Endpoints...'
        Enabled = False
        HelpContext = 3543
        OnClick = miModpathEndpointsClick
      end
      object miConfigureTimeSeries: TMenuItem
        Caption = 'Configure Time Series...'
        Enabled = False
        HelpContext = 3544
        OnClick = miModpathTimeSeriesClick
      end
      object ShowGridValues1: TMenuItem
        Action = acShowGridValues
      end
    ...
    object Model1: TMenuItem
      ...
      object miPackages: TMenuItem
        Caption = 'MODFLOW Pac&kages and Programs...'
        GroupIndex = 1
        HelpContext = 2540
  ...
  object alActionList: TActionList
    ...
    object acModflowActive: TAction
      ...
      HelpContext = 2390
      HelpKeyword = 'Model'
      Hint = 'Make MODFLOW the selected model type'
    ...
    object acColorGrid: TAction
      Category = 'Data'
      Caption = '&Color Grid...'
      HelpContext = 1870
      HelpKeyword = 'Color_Grid_Dialog_Box'
      Hint = 'Color grid|Color grid with data set or boundary condition values'
      ImageIndex = 70
      ShortCut = 49219
  ...
  object ilImageList: TImageList
    ...
    Bitmap = {
      ...
      01000000000000000000000000000000000000000000FF000000FF000000FF00
      ...
      
