...
uses
  ...
  ModflowBoundaryUnit, DataSetUnit, ModflowHobUnit;
...
type
  ...
  TMt3dmsTransObservations = class(TCustomLocationObsBoundary)
  private
...
resourcestring
  ErrorRoot = 'Error: Duplicate concentration observation times';
