...
begin
  FDiameter := CreateFormulaObject(dso3D);
  FTortuosity := CreateFormulaObject(dso3D);
  FRoughnessHeight := CreateFormulaObject(dso3D);
  FLowerCriticalR := CreateFormulaObject(dso3D);
  FHigherCriticalR := CreateFormulaObject(dso3D);
  FConductancePermeability := CreateFormulaObject(dso3D);
...
begin
  UpdateFormula(Value, ConductancePermeabilityPosition, FConductancePermeability);
end;

procedure TCfpPipeBoundary.SetDiameter(const Value: string);
begin
  UpdateFormula(Value, DiameterPosition, FDiameter);
end;
...
begin
  UpdateFormula(Value, HigherCriticalRPosition, FHigherCriticalR);
end;

procedure TCfpPipeBoundary.SetLowerCriticalR(const Value: string);
begin
  UpdateFormula(Value, LowerCriticalRPosition, FLowerCriticalR);
end;
...
begin
  UpdateFormula(Value, RoughnessHeightPosition, FRoughnessHeight);
end;

procedure TCfpPipeBoundary.SetTortuosity(const Value: string);
begin
  UpdateFormula(Value, TortuosityPosition, FTortuosity);
end;
