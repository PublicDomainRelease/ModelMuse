...
type
  ...
  TSfrTableRowItem = class(TOrderedItem)
  private
    FObserverList: TList;
    FFormulaList: TList;
...
class function TSfrTableCollection.ItemClass: TMF_BoundItemClass;
begin
...
begin
  UpdateFormula(Value, FDepthObserver, FDepth);
end;

procedure TSfrTableRowItem.SetFlow(const Value: string);
begin
  UpdateFormula(Value, FFlowObserver, FFlow);
end;

procedure TSfrTableRowItem.SetWidth(const Value: string);
begin
  UpdateFormula(Value, FWidthObserver, FWidth);
end;
