...
const
  ParamRecords: array[Low(TParameterType).. High(TParameterType)]
    ...
    ((Package: 'Unknown'; PType: 'Unknown'; PClass: pctUnknown),
     (Package: 'LPF'; PType: 'HK'; PClass: pctSteady),
     (Package: 'LPF'; PType: 'HANI'; PClass: pctSteady),
     (Package: 'LPF'; PType: 'VK'; PClass: pctSteady),
     (Package: 'LPF'; PType: 'VANI'; PClass: pctSteady),
     (Package: 'LPF'; PType: 'SS'; PClass: pctSteady),
     (Package: 'LPF'; PType: 'SY'; PClass: pctSteady),
     (Package: 'LPF'; PType: 'VKCB'; PClass: pctSteady),
...
begin
  ...
  case ParamType of
    ...
    ptLPF_HK: result := Packages.LpfPackage.IsSelected;
    ptLPF_HANI: result := Packages.LpfPackage.IsSelected;
    ptLPF_VK: result := Packages.LpfPackage.IsSelected;
    ptLPF_VANI: result := Packages.LpfPackage.IsSelected;
    ptLPF_SS: result := Packages.LpfPackage.IsSelected and TransientModel;
    ptLPF_SY: result := Packages.LpfPackage.IsSelected and TransientModel;
    ptLPF_VKCB: result := Packages.LpfPackage.IsSelected;
    ptRCH: result := Packages.RchPackage.IsSelected;
    ptEVT: result := Packages.EvtPackage.IsSelected;
    ptETS: result := Packages.EtsPackage.IsSelected;
    ptCHD: result := Packages.ChdBoundary.IsSelected;
    ptGHB: result := Packages.GhbBoundary.IsSelected;
    ptQ: result := Packages.WelPackage.IsSelected;
    ptRIV: result := Packages.RivPackage.IsSelected;
    ptDRN: result := Packages.DrnPackage.IsSelected;
    ptDRT: result := Packages.DrtPackage.IsSelected;
    ptSFR: result := Packages.SfrPackage.IsSelected;
    ptHFB: result := Packages.HfbPackage.IsSelected;
    ptHUF_HK: result := Packages.HufPackage.IsSelected;
    ptHUF_HANI: result := Packages.HufPackage.IsSelected;
    ptHUF_VK: result := Packages.HufPackage.IsSelected;
    ptHUF_VANI: result := Packages.HufPackage.IsSelected;
    ptHUF_SS: result := Packages.HufPackage.IsSelected and TransientModel;
    ptHUF_SY: result := Packages.HufPackage.IsSelected and TransientModel;
    ptHUF_SYTP: result := Packages.HufPackage.IsSelected and TransientModel;
    ptHUF_KDEP: result := Packages.HufPackage.IsSelected;
    ptHUF_LVDA: result := Packages.HufPackage.IsSelected;
    else Assert(False);
  end;
end;
