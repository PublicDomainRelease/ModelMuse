...
begin
  ...
  case ParamType of
    ...
    ptLPF_HK: result := frmGoPhast.PhastModel.LpfIsSelected;
    ptLPF_HANI: result := frmGoPhast.PhastModel.LpfIsSelected;
    ptLPF_VK: result := frmGoPhast.PhastModel.LpfIsSelected;
    ptLPF_VANI: result := frmGoPhast.PhastModel.LpfIsSelected;
    ptLPF_SS: result := frmGoPhast.PhastModel.LpfIsSelected and TransientModel;
    ptLPF_SY: result := frmGoPhast.PhastModel.LpfIsSelected and TransientModel;
    ptLPF_VKCB: result := frmGoPhast.PhastModel.LpfIsSelected;
