...
uses
  AbstractGridUnit, GoPhastTypes, GR32, ZoomBox2;
...
procedure TFootprintGrid.DrawFront(const BitMap: TBitmap32;
...
procedure TFootprintGrid.DrawSide(const BitMap: TBitmap32;
  const ZoomBox: TQRbwZoomBox2);
begin
// do nothing
