...
uses
  ...
  JvCombobox, JvListComb, ArgusDataEntry, framePlotGridUnit;
...
begin
  ...
  begin
    ...
    case MainCol of
      ...
      mcRestrictions, mcWeirDischarge, mcStructureWidth:
        begin
          CanSelect := (StructureItemIndex >= 0)
      ...
      mcInitialValue:
        begin
          CanSelect := (StructureItemIndex >= 0)
            ...
            sstGatedSpillway, sstSpillEquation, sstManning]);
      ...
      mcInitialValueTabFile:
        begin
          CanSelect := (StructureItemIndex >= 0)
            and (TSwrStructureType(StructureItemIndex) in [sstManning])
    ...
    case MainCol of
      mcName:
        begin
          ...
          Self.frameTiming.Grid.Cells[ARow+1, 0] := Value;
        end;
      mcReach:
        begin
          ...
          begin
            ...
            case StructureType of
              ...
              sstNone, sstSpecifiedElevation, sstPump, sstStageDishargeTable,
                sstFixedWeir, sstFixedSpillway, sstMoveableWeir,
                sstGatedSpillway, sstSpillEquation, sstSfrInflow:
                begin
                  CanSelect := False;
                end;
              else
