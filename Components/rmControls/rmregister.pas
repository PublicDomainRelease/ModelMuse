...
begin
  ...
  //Components Registration
     ...
     RegisterComponents(PalettePages[5],[TrmOutlookActionLink, TrmNoteBookControl, TrmTabbedNoteBookControl, TrmDayView]);
     ...
     RegisterComponentEditor(TrmCustomNotebookControl, TrmCustomNotebookControlEditor);
     RegisterComponentEditor(TrmNoteBookPage, TrmCustomNotebookControlEditor);
end;
