...
C8------READ BARRIERS NOT DEFINED BY PARAMETERS (ITEM 4)
      NHFB = 0
      WRITE(IOUT,*) 'BARRIERS NOT DEFINED BY PARAMETERS:'
...
C6------Write the values that were read.
      NN = II-LSTBEG+1
	WRITE(IOUT,*) 'Layer IROW1 ICOL1 IROW2  ICOL2 Factor:'
	WRITE(IOUT,*) K,I1,J1,I2,J2,HFB(6,II)
